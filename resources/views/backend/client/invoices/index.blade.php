                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <!-- About User -->
                            <div class="card">
                                <h5 class="card-header d-flex align-items-center">My Products & Services</h5>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ \Carbon\Carbon::parse($item['duedate'])->format('d M Y') }}
                                                </td>

                                                <td>
                                                    @if($item['datepaid'] != "0000-00-00 00:00:00")
                                                    {{ \Carbon\Carbon::parse($item['datepaid'])->format('d M Y') }}
                                                    @else
                                                    -
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    {{ $item['currencyprefix'] }}{{ number_format($item['total'], 2) }}
                                                </td>

                                                <td>
                                                    {{ ucfirst($item['paymentmethod']) }}
                                                </td>
                                                ...
                                                <td>
                                                    <form method="POST" action="{{route('admin.users.invoice.action')}}" class="invoiceActionForm">
                                                        @csrf
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li><button class="dropdown-item js-invoice-action"
                                                                            type="submit" data-action="mark_paid">Mark
                                                                            Paid</button></li>
                                                                    <li><button class="dropdown-item js-invoice-action"
                                                                            type="button" data-action="mark_unpaid">Mark
                                                                            Unpaid</button></li>
                                                                    <li><button class="dropdown-item js-invoice-action"
                                                                            type="button"
                                                                            data-action="mark_cancelled">Mark
                                                                            Cancelled</button></li>
                                                                    <li><button class="dropdown-item js-invoice-action"
                                                                            type="submit"
                                                                            data-action="duplicate_invoice">Duplicate
                                                                            Invoice</button></li>
                                                                    <li><button class="dropdown-item js-invoice-action"
                                                                            type="button"
                                                                            data-action="send_reminder">Send
                                                                            Reminder</button></li>
                                                                    <li><button class="dropdown-item js-invoice-action"
                                                                            type="button"
                                                                            data-action="merge">Merge</button></li>
                                                                    <li><button class="dropdown-item js-invoice-action"
                                                                            type="button" data-action="mass_pay">Mass
                                                                            Pay</button></li>
                                                                    <li><button
                                                                            class="dropdown-item js-invoice-action text-danger"
                                                                            type="button"
                                                                            data-action="delete">Delete</button></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </form>
