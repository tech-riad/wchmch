                                    ...
                                    <div class="tab-pane fade show active" id="profileContent">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="mb-0">Add Billable Item</h5>
                                            </div>

                                            <div class="card-body">
                                                <form method="post" action="{{ route('admin.users.billableitems.store', ['clientid' => $client['id']]) }}">
                                                    @csrf
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="pid" class="form-select @error('pid') is-invalid @enderror">
                                                                <option value="">None</option>
                                                                <optgroup label="Drew Ashley">
                                                                    <option value="1" {{ old('pid') == '1' ? 'selected' : '' }}>Olga Hudson</option>
                                                                    <option value="2" {{ old('pid') == '2' ? 'selected' : '' }}>Maxwell Clark</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('pid')
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label">Hours/Qty</label>
                                                            <div class="d-flex flex-wrap align-items-center gap-3">
                                                                ...
                                                                <div class="form-check">
                                                                    ...
                                                                    <input class="form-check-input" type="radio" name="unit" value="hours" id="unitval0" {{ old('unit', 'hours') == 'hours' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="unitval0">Hours</label>
                                                                </div>

                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="unit" value="quantity" id="unitval1" {{ old('unit') == 'quantity' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="unitval1">Qty</label>
                                                                </div>
                                                            </div>
                                                            @error('hours')
                                                        ...
                                                        <div class="col-12">
                                                            <label class="form-label d-block">Invoice Action</label>

                                                            <div class="d-flex flex-column gap-2">

                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="invoiceaction" value="noinvoice" id="invac0" {{ old('invoiceaction', 'noinvoice') == 'noinvoice' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="invac0">
                                                                        Don't Invoice for Now
                                                                    </label>
                                                                </div>

                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="invoiceaction" value="nextcron" id="invac1" {{ old('invoiceaction') == 'nextcron' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="invac1">
                                                                        Invoice on Next Cron Run
                                                                    </label>
                                                                </div>

                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="invoiceaction" value="nextinvoice" id="invac2" {{ old('invoiceaction') == 'nextinvoice' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="invac2">
                                                                        Add to User's Next Invoice
                                                                    </label>
                                                                </div>

                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="invoiceaction" value="duedate" id="invac3" {{ old('invoiceaction') == 'duedate' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="invac3">
                                                                        Invoice as Normal for Due Date
                                                                    </label>
                                                                </div>

                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="invoiceaction" value="recur" id="invac4" {{ old('invoiceaction') == 'recur' ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="invac4">
                                                                        Recur Every
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="row g-2 ms-1">
                                                                    <div class="col-auto">
                                                                        <input type="text"
                                                                            name="recur"
                                                                            value="{{ old('recur', '0') }}"
                                                                            class="form-control @error('recur') is-invalid @enderror"
                                                                            style="width: 90px;">
                                                                    </div>

                                                                    <div class="col-auto">
                                                                        <select name="recurcycle" class="form-select @error('recurcycle') is-invalid @enderror">
                                                                            <option value="">Never</option>
                                                                            <option value="Days" {{ old('recurcycle') == 'Days' ? 'selected' : '' }}>Days</option>
                                                                            <option value="Weeks" {{ old('recurcycle') == 'Weeks' ? 'selected' : '' }}>Weeks</option>
                                                                            <option value="Months" {{ old('recurcycle') == 'Months' ? 'selected' : '' }}>Months</option>
                                                                            <option value="Years" {{ old('recurcycle') == 'Years' ? 'selected' : '' }}>Years</option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <input type="text"
                                                                            name="recurfor"
                                                                            value="{{ old('recurfor') }}"
                                                                            class="form-control @error('recurfor') is-invalid @enderror"
                                                                            style="width: 90px;">
                                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label">Invoice Count</label>
                                                            <input type="text"
                                                                name="invoicecount"
                                                                value="{{ old('invoicecount', '0') }}"
                                                                class="form-control @error('invoicecount') is-invalid @enderror"
                                                                style="max-width: 140px;">
                                                            @error('invoicecount')
