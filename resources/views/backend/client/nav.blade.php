            ...
            <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i
                            class="icon-base ti tabler-user-check icon-sm me-1_5"></i> Summary</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.users.edit', $client['id'])}}"><i
                            class="icon-base ti tabler-users icon-sm me-1_5"></i> Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.users.contact', $client['id'])}}"><i
