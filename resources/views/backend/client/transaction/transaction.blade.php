                            ...
                            <div class="card">
                                <div class="tab-pane fade show active" id="profileContent">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <a href="/admin/clientstransactions.php?userid=9&amp;action=add"
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <form method="post" action="/admin/clientstransactions.php" class="row g-2 align-items-center">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tr>
                                                    <th>
                                                    <a class="text-decoration-none" href="/admin/clientstransactions.php?userid=9&amp;orderby=date">
                                                        Date
                                                        <i class="ti ti-arrow-down ms-1 text-muted"></i>
                                                    </a>
                                                    </th>
                                                    <th>
                                                    <a class="text-decoration-none" href="/admin/clientstransactions.php?userid=9&amp;orderby=gateway">
                                                        Payment Method
                                                    </a>
                                                    </th>
                                                    <th>
                                                    <a class="text-decoration-none" href="/admin/clientstransactions.php?userid=9&amp;orderby=description">
                                                        Description
                                                    </a>
                                                    </th>
                                                    <th class="text-end">
                                                    <a class="text-decoration-none" href="/admin/clientstransactions.php?userid=9&amp;orderby=amountin">
                                                        Amount In
                                                    </a>
                                                    </th>
                                                    <th class="text-end">
                                                    <a class="text-decoration-none" href="/admin/clientstransactions.php?userid=9&amp;orderby=fees">
                                                        Fees
                                                    </a>
                                                    </th>
                                                    <th class="text-end">
                                                    <a class="text-decoration-none" href="/admin/clientstransactions.php?userid=9&amp;orderby=amountout">
                                                        Amount Out
                                                    </a>
                                                    </th>
